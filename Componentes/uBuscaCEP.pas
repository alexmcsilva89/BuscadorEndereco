...
uses
  ...
  XML.XMLSchemaTags, uEnumTipoConsulta;
...
begin
  AXMLDocument.FileName := AXMLDocument.FileName + FCEP + '/' + FTipoRetornoConsulta.PegarRecurso + '/';
end;

procedure TBuscaCep.AdicionarRecursoEndereco(AXMLDocument: IXMLDocument);
begin
  AXMLDocument.FileName := AXMLDocument.FileName + FESTADO + '/' + FCIDADE + '/'+
                           FEndereco + '/' + FTipoRetornoConsulta.PegarRecurso + '/';
end;
...
begin
  ...
  ARESTRequest.Params.AddUrlSegment(sPARAMETRO_UF, FEstado);
  ARESTRequest.Params.AddUrlSegment(sPARAMETRO_CIDADE, FCidade);
  ARESTRequest.Params.AddUrlSegment(sPARAMETRO_LOGRADOURO, FEndereco);
end;
