unit BuscadorEndereco.View.Principal;
...
uses
  ...
  Vcl.DBCtrls, Vcl.Grids, Vcl.DBGrids, BuscadorEndereco.Controller.Interfaces,
...
uses BuscadorEndereco.Controller.Conexao, BuscadorEndereco.Controller.Endereco,
