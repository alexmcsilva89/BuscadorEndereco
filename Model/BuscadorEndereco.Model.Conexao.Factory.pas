unit BuscadorEndereco.Model.Conexao.Factory;

interface

uses
  BuscadorEndereco.Model.Interfaces, BuscadorEndereco.Model.Conexao.Enum.Driver;
...
uses
  BuscadorEndereco.Model.Conexao.SQLite, System.SysUtils;
